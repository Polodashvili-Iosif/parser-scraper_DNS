...
# Нужно доделать до универсального создания таблиц и добавления данных,
# чтобы функцию добавить в converter.py
def to_postgresql_database(data: Iterable[Mapping[str, Any]],
    ...
    with connect(host=host, user=user,
                 password=password, database=database) as connection:
